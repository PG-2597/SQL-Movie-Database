...
Select distinct job_title as job_name from jobs;

Select concat(FIRST_NAME,' ',LAST_NAME) as Employee_Name ,salary  as Number_of_Dollars from employees;
update employees SET SALARY = SALARY * 1.15 where EMPLOYEE_ID >99;
# this is showing an error without where clause, is it compulsory to use where?

Select concat(FIRST_NAME,' ',LAST_NAME)||' '||job_title as "Employee&Job"
from employees, jobs;
# getting null values here
Select * from employees;
Select EMPLOYEE_ID, concat(FIRST_NAME,' ',LAST_NAME) as Employee_Name, SALARY, HIRE_DATE from employees
where HIRE_DATE like (1991-02-22);
Select count(FIRST_NAME) from employees;
# tried but did not get how to solve this query
Select length(FIRST_NAME) from employees;
Select EMPLOYEE_ID, SALARY, COMMISSION_PCT from employees;
Select distinct(DEPARTMENT_NAME), DEPARTMENT_ID, job_title as job_name from departments, jobs
group by job_title, DEPARTMENT_NAME;
Select * from employees
where HIRE_DATE < ('1991-01-01');
Select avg(SALARY) from employees, jobs
